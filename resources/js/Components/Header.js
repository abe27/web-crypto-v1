...
const Header = ({
  ...
  addLoading = false,
  routeTo = 'dashboard.index',
  refreshLoading = false,
  handleReloadButton = false,
}) => {
  return (
    <div className="my-6 lg:my-12 container mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between border-b border-gray-300">
      ...
      <div className="mt-6 lg:mt-0">
        ...
        >
          ...
          {!addLoading && <i className="fa-solid fa-plus mr-2"></i>}
          เพิ่มข้อมูล
        </a>
        <button
        ...
        >
          ...
          {!refreshLoading && <i className="fa-solid fa-rotate-right mr-2"></i>}
          โหลดอีกครั้ง
        </button>
      </div>
    </div>
